...
lobby Closed status still enters the normal recovery/closure path. Only actual
Left/Kicked/Disconnected callbacks provide retirement evidence. Promotion is not
