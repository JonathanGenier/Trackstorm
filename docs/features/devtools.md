...
| --- | --- | --- |
| Configs | `DeveloperOptionsPanel`, `DeveloperOptionsDraft`, `DevelopmentSession` and the existing Core configuration validators | Editable configuration and authorized developer actions; host and connected synchronized clients request shared configuration changes; host-only actions retain their authority. |
