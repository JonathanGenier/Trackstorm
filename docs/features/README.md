...
| [Held items](items.md) | Generic item registry, two-slot authority and selection, persistent Oil and magnetic Proxy Mine hazards, sustained percentage Nitro rocket thrust, outcomes and local HUD identity | [Pickups](item-spawns.md), [damage](vehicles.md), [lifecycle](death-respawn.md) |
