...
| [Surface/material identity](surfaces.md) | Authored materials, native support identity and local Stats; no handling effects | [Vehicles](vehicles.md), [oval map](oval-map.md), [Stats](statistics.md) |
...
| [Held items](items.md) | Generic four-item registry, one-slot authority, persistent Oil hazards, temporary Nitro boost, outcomes and local HUD identity | [Pickups](item-spawns.md), [damage](vehicles.md), [lifecycle](death-respawn.md) |
