...
| [Held items](items.md) | Generic four-item registry, one-slot authority, persistent Oil hazards, outcomes and local HUD identity | [Pickups](item-spawns.md), [damage](vehicles.md), [lifecycle](death-respawn.md) |
