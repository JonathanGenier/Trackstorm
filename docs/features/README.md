...
| [Play Menu](play-menu.md) | Hanging lobby browser, Search/Filter, double activation, retained decision and chain transitions | [Main Menu](main-menu.md), [EOS lobbies](eos-lobbies.md), [reconnection](reconnection.md) |
...
| [Developer Options](developer-options.md) | Shared host-validated tuning, session ownership, replication, export, F1 and authorized actions | [DevTools shell](devtools.md), [Statistic Panel](statistics.md), [Settings](settings.md), [vehicle networking](vehicle-networking.md) |
...
| [Held items](items.md) | Generic item registry, sustained close-range Machine Gun, arcing Salvo and local impact guide, two-slot authority and selection, persistent Oil and magnetic Proxy Mine hazards, sustained percentage Nitro rocket thrust, outcomes and local HUD identity | [Pickups](item-spawns.md), [damage](vehicles.md), [lifecycle](death-respawn.md) |
...
| [Match scoring](matches.md) | Countdown, attribution, Circus combat/K/D/streaks, pending stunt detection/banking, Circus time limit and first-to-target | [Game Loop](game-loop.md), [lifecycle](death-respawn.md), [sessions](sessions.md), [HUD](hud.md) |
