...
| [Held items](items.md) | Generic item registry, arcing Salvo and local impact guide, two-slot authority and selection, persistent Oil hazards, sustained percentage Nitro rocket thrust, outcomes and local HUD identity | [Pickups](item-spawns.md), [damage](vehicles.md), [lifecycle](death-respawn.md) |
