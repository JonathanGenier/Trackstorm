...
| [Held items](items.md) | Generic item registry, two-slot authority and selection, persistent Oil and magnetic Proxy Mine hazards, temporary Nitro boost, outcomes and local HUD identity | [Pickups](item-spawns.md), [damage](vehicles.md), [lifecycle](death-respawn.md) |
