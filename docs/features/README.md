...
| [Held items](items.md) | Generic four-item registry, one-slot authority, outcomes and local HUD identity | [Pickups](item-spawns.md), [damage](vehicles.md), [lifecycle](death-respawn.md) |
