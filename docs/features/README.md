...
| [Reconnection and session resume](reconnection.md) | Stable identity, match-long retention, authenticated rebind and full checkpoint recovery | [Sessions](sessions.md), [vehicle networking](vehicle-networking.md), [EOS P2P](eos-p2p.md) |
