...
| Evidence | Reports |
| --- | --- |
| Modular chain-hung Main Menu, left-side layout and stationary assembly with stronger fabric flutter | [TS-122 implementation and verification](ts-122.md), [Astra runtime critique](ts-122-critique.md) |
