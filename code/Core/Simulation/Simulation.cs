...
public sealed class Simulation
{
    ...
    internal IReadOnlyList<VehicleStepResult> Step(InputFrame input, IReadOnlyList<VehicleStepRequest> requests, IReadOnlyList<RuntimeEvent>? precedingEvents)
    {
        ...
        {
            var observation = new VehicleObservation(request.Observation.Physics, request.Observation.Support, request.Observation.Contacts.Where(contact => Participates(contact.OtherVehicleId)), request.Observation.Surface, request.Observation.Wheels, request.Observation.TerrainSupport);
