...
/// <param name="CircusScore">Authoritative banked Circus points.</param>
/// <param name="Kills">Authoritative kills.</param>
/// <param name="Deaths">Authoritative deaths.</param>
public sealed record MatchStanding(ulong PlayerId, int Rank, double CircusScore, int Kills, int Deaths);
