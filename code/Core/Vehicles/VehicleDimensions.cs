...
public static class VehicleDimensions
{
    ...
    /// <summary>Authored vertical tire radius; existing meshes follow suspension travel.</summary>
    public const float WheelRadius = 0.354f * Scale;
    /// <summary>Origin above a level road at default spring equilibrium.</summary>
    public const float RideHeight = 1.145f;
    /// <summary>Additional spawn height above the oval's original 0.85 m markers, clearing the lifted chassis during reconstruction.</summary>
    public const float SpawnLift = 0.45f;
