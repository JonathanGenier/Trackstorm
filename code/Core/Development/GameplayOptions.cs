...
public static class GameplayOptions
{
    ...
    [
        ...
        new("items.salvo_interval_ticks", "Salvo", "Launch interval at 60 Hz", true, c => c.Items.SalvoIntervalTicks, (c, v) => c with { Items = c.Items with { SalvoIntervalTicks = checked((int)v) } }),
