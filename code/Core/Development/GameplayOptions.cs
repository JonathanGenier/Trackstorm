...
public static class GameplayOptions
{
    ...
    [
        ...
        new("match.base_kill_points", "Match", "BaseKillPoints", false, c => c.Match.BaseKillPoints, (c, v) => c with { Match = c.Match with { BaseKillPoints = v } }),
        new("match.kill_streak_bonus_step", "Match", "KillStreakBonusStep", false, c => c.Match.KillStreakBonusStep, (c, v) => c with { Match = c.Match with { KillStreakBonusStep = v } }),
        new("match.collision_points_per_damage", "Match", "CollisionPointsPerDamage", false, c => c.Match.CollisionPointsPerDamage, (c, v) => c with { Match = c.Match with { CollisionPointsPerDamage = v } }),
