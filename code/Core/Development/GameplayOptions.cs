...
public static class GameplayOptions
{
    ...
    [
        ...
        new("items.salvo_count", "Salvo", "Rounds per salvo", true, c => c.Items.SalvoCount, (c, v) => c with { Items = c.Items with { SalvoCount = checked((int)v) } }),
        new("items.salvo_interval_ticks", "Salvo", "Launch interval (ticks; 30 = 0.5 seconds)", true, c => c.Items.SalvoIntervalTicks, (c, v) => c with { Items = c.Items with { SalvoIntervalTicks = checked((int)v) } }),
