...
{
    /// <summary>Optional complete arc continuation; null retains the straight projectile contract.</summary>
    ...
    /// <summary>A staged shot has no world/audio representation until its first committed step.</summary>
