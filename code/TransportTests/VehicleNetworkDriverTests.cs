...
internal sealed partial class VehicleNetworkDriverTests
{
    ...
    public void MatchPublicationsRejectForgedStaleUnreliableAndPostFinishState()
    {
        ...
        client.Advance(default, Observe);
        var active = new MatchState(1, 1, 5, MatchPhase.Active, null, null, [new PlayerScore(1, 0, 0, 0, 0) { CircusScore = 12.5, Stunts = new StuntState { Life = 1, Tick = 1, TopSpeed = new(1, 5d / 60) } }, new PlayerScore(2, 0, 0, 0, 0) { ProcessedDamageLife = 1, ProcessedDamageSequence = 1 }]);
