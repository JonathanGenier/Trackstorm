...
internal sealed class LobbyTests
{
    ...
    public void DisconnectPolicyIsExplicitlyPhaseSpecific()
    {
        ...
        Assert.That(lobby.Join(10, GameVersion.Current.ToString(), "Client", "client"), Is.EqualTo(2));
        ...
        Assert.That(lobby.Resume(20, GameVersion.Current.ToString(), 100, 2, 1, "client"), Is.False);
        Assert.That(lobby.Join(20, GameVersion.Current.ToString(), "Client", "client"), Is.EqualTo(3), "A returning lobby member is a fresh admission.");
        ...
        Assert.That(lobby.Resume(30, GameVersion.Current.ToString(), 100, 3, 1, "client"), Is.True);
