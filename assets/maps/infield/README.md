...
`source/InfieldGraybox.blend` is the editable baseline Blender source. The game
now instances terrain and [production structures](STRUCTURES.md) beneath the
scriptless production oval, rather than this graybox. One unit is one metre.
